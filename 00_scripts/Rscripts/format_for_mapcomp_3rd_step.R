...
marker_seq<-read.table(paste0(MAPCOMPDIR,MAP1,".seq"), stringsAsFactors=F)[,3:4]
...
write.table (map_LG_pos_seq, paste0(MAPCOMPDIR,MAP1,".csv"), col.names=F, row.names=F, quote=F, sep=",")